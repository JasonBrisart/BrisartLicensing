...
The subscription program exists to support continued development of Brisart ecosystem software.

Subscriptions may help fund:
...
- New archival workflows
- New preservation capabilities
- New identity verification tools
- New offline authentication experiments
- New developer utilities
- New local-first infrastructure tools
- Improvements to existing Brisart projects
...
## What A Subscription Does Not Provide

The Brisart Subscription Program does not provide:
...
A subscription may apply across the Brisart ecosystem, including:
...
and future Brisart ecosystem projects unless explicitly stated otherwise.

---

## Philosophy

The software is built because the Brisart ecosystem needs it.
